...
<body>
    <center>
        <table border="0" width="670" cellspacing="0" cellpadding="0" style="margin-top:5"> 
            <tr height="30"><td style="text-indent:5" valign="bottom"><font color="#004790"><b>■查询已经交换物品结果</b></font></td></tr>
                    ...
                    <table border="0" width="100%" rules="rows" cellspacing="0">
                        ...
                        <c:choose>
                        	<c:when test="${searchGoodsList==null || searchGoodsList.size()==0 }">
                        		<tr height="80"><td colspan="8" align="center">★★对不起，未找到已经交换物品！★★</td></tr>
                        	</c:when>
                        	<c:otherwise>
